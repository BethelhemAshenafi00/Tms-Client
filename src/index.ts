...
import { isStudent, Student } from "./models/student.model";
...
import { ApiResponse, renderApiResponse } from "./models/api-response.model";
...
console.log(renderApiResponse(studentRes, (s) => `${s.name} GPA: ${s.gpa ?? "N/A"}`));
